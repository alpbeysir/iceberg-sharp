...
{
    private const string MetadataSchemaKey = "schema";
    private const string MetadataSchemaIdKey = "schema-id";
    private const string MetadataPartitionSpecKey = "partition-spec";
    private const string MetadataPartitionSpecIdKey = "partition-spec-id";
    private const string MetadataFormatVersionKey = "format-version";
    private const string MetadataContentKey = "content";
