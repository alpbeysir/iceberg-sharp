...
public static class BitUtility
{
    ...
    {
        return (data[index / 8] & BitMask[index % 8]) != 0;
    }
    ...
    {
        return CountBits(data, index, data.Length * 8 - index);
    }
    ...
    {
        return RoundUpToMultiplePowerOfTwo(n, 64);
    }
    ...
    {
        return RoundUpToMultiplePowerOfTwo(n, 8);
    }
