...
/// </summary>
public sealed class OcfReader : IDisposable
{
    ...
    private OcfReader(Stream stream, AvroRecordSchema writerSchema, AvroSchema writerAvroSchema, AvroCodec codec,
    ...
    public static OcfReader Open(Stream stream)
    {
        ...
        return new OcfReader(stream, recordSchema, writerSchema, codec, syncMarker, metadata);
    }
